...
extern int xfer_deliver_iob_meta ( struct interface *intf,
				   struct io_buffer *iobuf,
				   struct xfer_metadata *meta );
#define xfer_deliver_iob_meta_TYPE( object_type )		\
	typeof ( int ( object_type, struct io_buffer *iobuf,	\
		       struct xfer_metadata *meta ) )

extern int xfer_deliver_raw ( struct interface *intf,
			      const void *data, size_t len );
#define xfer_deliver_raw_TYPE( object_type ) \
	typeof ( int ( object_type, const void *data, size_t len ) )
...
extern int xfer_printf ( struct interface *intf,
			 const char *format, ... );
