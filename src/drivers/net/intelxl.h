...
/** Admin queue Query VSI Bandwidth Configuration command */
#define INTELXL_ADMIN_BANDWIDTH 0x0408

/** Admin queue Query VSI Bandwidth Configuration command parameters */
struct intelxl_admin_bandwidth_params {
	/** VSI switching element ID */
	uint16_t vsi;
	/** Reserved */
	uint8_t reserved[6];
...
/** Admin queue Query VSI Bandwidth Configuration data buffer */
struct intelxl_admin_bandwidth_buffer {
	/** Valid traffic classes */
	uint8_t valid;
	/** Suspended traffic classes */
	uint8_t suspended;
	/** Reserved */
	uint8_t reserved_a[14];
	...
	/** Reserved */
	uint8_t reserved_c[2];
	/** Bandwidth limit maximum */
	uint8_t max;
	/** Reserved */
	uint8_t reserved_d[23];
} __attribute__ (( packed ));
...
union intelxl_admin_params {
	...
	/** Query VSI Bandwidth Configuration command parameters */
...
union intelxl_admin_buffer {
	...
	/** Query VSI Bandwidth Configuration buffer */
	struct intelxl_admin_bandwidth_buffer bandwidth;
} __attribute__ (( packed ));
