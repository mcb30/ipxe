...
#define HERMON_HCR_RST2INIT_QPEE	0x0019
#define HERMON_HCR_INIT2RTR_QPEE	0x001a
#define HERMON_HCR_RTR2RTS_QPEE		0x001b
#define HERMON_HCR_2RST_QPEE		0x0021
...
#define HERMON_DB_POST_SND_OFFSET	0x10
...
struct MLX_DECLARE_STRUCT ( hermonprm_send_doorbell );
...
struct hermonprm_ud_send_wqe {
	struct hermonprm_wqe_segment_next next;
...
struct hermonprm_recv_wqe {
	 ...
	 */
	struct hermonprm_recv_wqe_segment_next next;
...
union hermonprm_doorbell_register {
	struct hermonprm_send_doorbell send;
	uint32_t dword[2];
} __attribute__ (( packed ));
...
#define HERMON_RECV_WQE_ALIGN 64
