...
init_i2c_device ( struct i2c_device *i2cdev, struct i2c_bus *i2c,
 ...
 */
static inline __attribute__ (( always_inline )) void
init_i2c_eeprom ( struct i2c_device *i2cdev, struct i2c_bus *i2c,
		  unsigned int dev_addr ) {
	init_i2c_device ( i2cdev, i2c, dev_addr, 1, 1 );
}
 ...
 */
static inline __attribute__ (( always_inline )) void
init_at24c11 ( struct i2c_device *i2cdev, struct i2c_bus *i2c ) {
	 ...
	 */
	init_i2c_device ( i2cdev, i2c, 0, 1, 0 );
}
